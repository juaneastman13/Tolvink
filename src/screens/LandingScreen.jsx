...
<section class="section" id="problema" style="position:relative;z-index:1">
  <div class="reveal"><div class="tag">El problema actual</div><h2 class="title">La logística agropecuaria es informal y con poca trazabilidad</h2><p class="sub">En Uruguay, la gran mayoría de la coordinación de fletes agrícolas se gestiona por llamada telefónica, WhatsApp informal y planillas Excel.</p><div class="hr"></div></div>
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px">
    <div class="card reveal" style="display:flex;gap:14px;align-items:flex-start"><div class="icon-box" style="background:var(--errPale)"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--err)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg></div><div><h3 style="font-size:15px;margin-bottom:4px">Coordinación telefónica</h3><p style="font-size:13px;color:var(--t2)">Decenas de llamadas diarias entre productores, plantas y choferes para confirmar cada viaje.</p></div></div>
    <div class="card reveal" style="display:flex;gap:14px;align-items:flex-start"><div class="icon-box" style="background:var(--errPale)"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--err)" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg></div><div><h3 style="font-size:15px;margin-bottom:4px">Registros manuales</h3><p style="font-size:13px;color:var(--t2)">Planillas sin actualización en tiempo real. Datos duplicados o perdidos.</p></div></div>
    <div class="card reveal" style="display:flex;gap:14px;align-items:flex-start"><div class="icon-box" style="background:var(--errPale)"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--err)" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div><div><h3 style="font-size:15px;margin-bottom:4px">Cero visibilidad</h3><p style="font-size:13px;color:var(--t2)">No hay forma de saber dónde está un camión. "Llama al chofer" es la única opción.</p></div></div>
    ...
    <div class="mockup-row" style="display:flex;gap:32px;align-items:flex-start;flex-wrap:wrap">
      ...
      <div style="flex:1;min-width:260px">
        ...
        <div style="display:flex;flex-direction:column;gap:8px">
          ...
          <div style="display:flex;align-items:center;gap:8px"><span class="status-pill" style="background:var(--secPale);color:#0E7490;font-size:11px">Asignado</span><span style="font-size:13px;color:var(--t2)">Camión y chofer confirmados</span></div>
    ...
    <div class="mockup-row" style="display:flex;gap:32px;align-items:flex-start;flex-wrap:wrap">
      ...
      <div style="flex:1;min-width:260px">
        ...
        <div style="display:flex;flex-direction:column;gap:10px">
          ...
          <div style="display:flex;gap:10px;align-items:flex-start"><div class="icon-box" style="background:var(--secPale);width:36px;height:36px"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--sec)" stroke-width="2"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg></div><div><div style="font-size:14px;font-weight:600">Alertas de vencimiento</div><p style="font-size:12px;color:var(--t2)">Semáforo: verde vigente, amarillo por vencer, rojo vencido.</p></div></div>
        </div>
      </div>
    </div>
  </div>
...
<section class="section" id="diferenciadores" style="position:relative;z-index:1">
  ...
  <div class="reveal" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:16px;margin-top:32px;text-align:center">
    ...
    <div style="padding:20px"><div style="font-size:28px;font-weight:800;color:var(--acc);font-family:var(--head)">Adopción orgánica</div><p style="font-size:13px;color:var(--t2);margin-top:4px">Una planta trae a toda su red.</p></div>
