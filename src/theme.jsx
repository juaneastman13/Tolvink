...
export const Ic = {
  ...
  grain:(c=C.pri,s=18)=><svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22V2"/><path d="M12 5l-5-3"/><path d="M12 5l5-3"/><path d="M12 9l-5.5-3"/><path d="M12 9l5.5-3"/><path d="M12 13l-5.5-3"/><path d="M12 13l5.5-3"/><path d="M12 17l-5-3"/><path d="M12 17l5-3"/></svg>,
  ...
  seedling:(c="#1A6B37",s=22)=><svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22V2"/><path d="M12 5l-5-3"/><path d="M12 5l5-3"/><path d="M12 9l-5.5-3"/><path d="M12 9l5.5-3"/><path d="M12 13l-5.5-3"/><path d="M12 13l5.5-3"/><path d="M12 17l-5-3"/><path d="M12 17l5-3"/></svg>,
