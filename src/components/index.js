// Barrel re-export — all UI components
...
export { FreightCard, FreightCardCompact, ActiveTripCard, CalendarChip, StatusPill, TripProgressBar, VerMatriculas } from "./FreightCard";
